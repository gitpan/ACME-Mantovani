# This Makefile is for the ACME::Mantovani extension to perl.
#
...
#     ABSTRACT_FROM => q[lib/ACME/Mantovani.pm]
...
#     NAME => q[ACME::Mantovani]
#     PL_FILES => {  }
#     PREREQ_PM => { Test::More=>q[0] }
#     TEST_REQUIRES => {  }
#     VERSION_FROM => q[lib/ACME/Mantovani.pm]
#     clean => { FILES=>q[ACME-Mantovani-*] }
...
MAN3EXT = 3pm
INSTALLDIRS = site
INSTALL_BASE = /Users/lucampos/perl5
DESTDIR = 
PREFIX = $(INSTALL_BASE)
...
MAKEMAKER   = /Users/lucampos/perl5/lib/perl5/ExtUtils/MakeMaker.pm
MM_VERSION  = 6.68
MM_REVISION = 66800
...
H_FILES  = 
MAN1PODS = 
MAN3PODS = lib/ACME/Mantovani.pm
...
TO_INST_PM = lib/ACME/Mantovani.pm

PM_TO_BLIB = lib/ACME/Mantovani.pm \
	blib/lib/ACME/Mantovani.pm
...
DISTNAME = ACME-Mantovani
DISTVNAME = ACME-Mantovani-0.01
...
manifypods : pure_all  \
	lib/ACME/Mantovani.pm
	$(NOECHO) $(POD2MAN) --section=3 --perm_rw=$(PERM_RW) \
	  lib/ACME/Mantovani.pm $(INST_MAN3DIR)/ACME::Mantovani.$(MAN3EXT) 
...
metafile : create_distdir
	...
	$(NOECHO) $(ECHO) 'abstract: '\''The great new ACME::Mantovani!'\''' >> META_new.yml
	$(NOECHO) $(ECHO) 'author:' >> META_new.yml
	$(NOECHO) $(ECHO) '  - '\''Campos <lmc@cpan.org>'\''' >> META_new.yml
	$(NOECHO) $(ECHO) 'build_requires:' >> META_new.yml
	$(NOECHO) $(ECHO) '  Test::More: 0' >> META_new.yml
	$(NOECHO) $(ECHO) 'configure_requires:' >> META_new.yml
	$(NOECHO) $(ECHO) '  ExtUtils::MakeMaker: 0' >> META_new.yml
	$(NOECHO) $(ECHO) 'dynamic_config: 1' >> META_new.yml
	$(NOECHO) $(ECHO) 'generated_by: '\''ExtUtils::MakeMaker version 6.68, CPAN::Meta::Converter version 2.131560'\''' >> META_new.yml
	$(NOECHO) $(ECHO) 'license: unknown' >> META_new.yml
	$(NOECHO) $(ECHO) 'meta-spec:' >> META_new.yml
	$(NOECHO) $(ECHO) '  url: http://module-build.sourceforge.net/META-spec-v1.4.html' >> META_new.yml
	$(NOECHO) $(ECHO) '  version: 1.4' >> META_new.yml
	$(NOECHO) $(ECHO) 'name: ACME-Mantovani' >> META_new.yml
	...
	$(NOECHO) $(ECHO) '   "abstract" : "The great new ACME::Mantovani!",' >> META_new.json
	$(NOECHO) $(ECHO) '   "author" : [' >> META_new.json
	$(NOECHO) $(ECHO) '      "Campos <lmc@cpan.org>"' >> META_new.json
	$(NOECHO) $(ECHO) '   ],' >> META_new.json
	$(NOECHO) $(ECHO) '   "dynamic_config" : 1,' >> META_new.json
	$(NOECHO) $(ECHO) '   "generated_by" : "ExtUtils::MakeMaker version 6.68, CPAN::Meta::Converter version 2.131560",' >> META_new.json
	...
	$(NOECHO) $(ECHO) '   },' >> META_new.json
	$(NOECHO) $(ECHO) '   "name" : "ACME-Mantovani",' >> META_new.json
...
ppd :
	...
	$(NOECHO) $(ECHO) '    <ABSTRACT>The great new ACME::Mantovani!</ABSTRACT>' >> $(DISTNAME).ppd
	$(NOECHO) $(ECHO) '    <AUTHOR>Campos &lt;lmc@cpan.org&gt;</AUTHOR>' >> $(DISTNAME).ppd
...
pm_to_blib : $(FIRST_MAKEFILE) $(TO_INST_PM)
	$(NOECHO) $(ABSPERLRUN) -MExtUtils::Install -e 'pm_to_blib({@ARGV}, '\''$(INST_LIB)/auto'\'', q[$(PM_FILTER)], '\''$(PERM_DIR)'\'')' -- \
	  lib/ACME/Mantovani.pm blib/lib/ACME/Mantovani.pm 
